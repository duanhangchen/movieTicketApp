...
public final class theater_002ddetail_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
    ...
    try {
      ...
      out.write("\">\n");
      out.write("\t\t\t\t\t\t\t\t<div class=\"card-block\" value=\"2017-05-17\" name=\"showDay\">\n");
      out.write("\t\t\t\t\t\t\t\t\t<h4 class=\"card-title\">\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<center>Tuesday</center>\n");
      out.write("\t\t\t\t\t\t\t\t\t</h4>\n");
      out.write("\t\t\t\t\t\t\t\t\t<p class=\"card-text\">\n");
      out.write("\t\t\t\t\t\t\t\t\t<center>May 17</center>\n");
      out.write("\t\t\t\t\t\t\t\t\t</p>\n");
      out.write("\t\t\t\t\t\t\t\t\t<br>\n");
      out.write("\t\t\t\t\t\t\t\t</div>\n");
      out.write("\t\t\t\t\t\t\t</a>\n");
      ...
      out.write("\n");
      out.write("\t\t\t\t\n");
      out.write("\t\t\t\t\t<a href=\"#\"> <a href=\"/showing/");
      out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.evaluateExpression("${theater.id}", java.lang.String.class, (PageContext)_jspx_page_context, null));
      out.write('/');
      out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.evaluateExpression("${time}", java.lang.String.class, (PageContext)_jspx_page_context, null));
      out.write("\">\n");
      out.write("\t\t\t\t\t\t\t<div class=\"card\">\n");
      out.write("\t\t\t\t\t\t\t\t<div class=\"card-block\" name=\"showDay\">\n");
      out.write("\t\t\t\t\t\t\t\t\t<h4 class=\"card-title\">\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<center>Wednesday</center>\n");
      out.write("\t\t\t\t\t\t\t\t\t</h4>\n");
      out.write("\t\t\t\t\t\t\t\t\t<p class=\"card-text\">\n");
      out.write("\t\t\t\t\t\t\t\t\t<center>May 18</center>\n");
      out.write("\t\t\t\t\t\t\t\t\t</p>\n");
      out.write("\t\t\t\t\t\t\t\t\t<br>\n");
      out.write("\t\t\t\t\t\t\t\t</div>\n");
      out.write("\t\t\t\t\t\t\t</div>\n");
      ...
      out.write("\t\t\t\t\t\t\t<div class=\"card-block\" name=\"showDay\">\n");
      out.write("\t\t\t\t\t\t\t\t<h4 class=\"card-title\">\n");
      out.write("\t\t\t\t\t\t\t\t\t<center>Thursday</center>\n");
      out.write("\t\t\t\t\t\t\t\t</h4>\n");
      out.write("\t\t\t\t\t\t\t\t<p class=\"card-text\">\n");
      out.write("\t\t\t\t\t\t\t\t<center>May 19</center>\n");
      out.write("\t\t\t\t\t\t\t\t</p>\n");
      out.write("\t\t\t\t\t\t\t\t<br>\n");
      out.write("\t\t\t\t\t\t\t</div>\n");
      out.write("\t\t\t\t\t\t</div>\n");
      ...
      out.write("\t\t\t\t\t\t\t\t<h4 class=\"card-title\">\n");
      out.write("\t\t\t\t\t\t\t\t\t<center>Friday</center>\n");
      out.write("\t\t\t\t\t\t\t\t</h4>\n");
      out.write("\t\t\t\t\t\t\t\t<p class=\"card-text\">\n");
      out.write("\t\t\t\t\t\t\t\t<center>May 20</center>\n");
      out.write("\t\t\t\t\t\t\t\t</p>\n");
      out.write("\t\t\t\t\t\t\t\t<br>\n");
      out.write("\t\t\t\t\t\t\t</div>\n");
      out.write("\t\t\t\t\t\t</div>\n");
      ...
      out.write("\t\t\t\t\t\t\t<div class=\"card-block\">\n");
      out.write("\t\t\t\t\t\t\t\t<h4 class=\"card-title\">\n");
      out.write("\t\t\t\t\t\t\t\t\t<center>Saturday</center>\n");
      out.write("\t\t\t\t\t\t\t\t</h4>\n");
      out.write("\t\t\t\t\t\t\t\t<p class=\"card-text\">\n");
      out.write("\t\t\t\t\t\t\t\t<center>May 21</center>\n");
      out.write("\t\t\t\t\t\t\t\t</p>\n");
      out.write("\t\t\t\t\t\t\t\t<br>\n");
      out.write("\t\t\t\t\t\t\t</div>\n");
      out.write("\t\t\t\t\t\t</div>\n");
      ...
      out.write("\t\t\t\t\t\t\t<div class=\"card-block\">\n");
      out.write("\t\t\t\t\t\t\t\t<h4 class=\"card-title\">\n");
      out.write("\t\t\t\t\t\t\t\t\t<center>Sunday</center>\n");
      out.write("\t\t\t\t\t\t\t\t</h4>\n");
      out.write("\t\t\t\t\t\t\t\t<p class=\"card-text\">\n");
      out.write("\t\t\t\t\t\t\t\t<center>May 22</center>\n");
      out.write("\t\t\t\t\t\t\t\t</p>\n");
      out.write("\t\t\t\t\t\t\t\t<br>\n");
      out.write("\t\t\t\t\t\t\t</div>\n");
      out.write("\t\t\t\t\t\t</div>\n");
      ...
      out.write("\t\t\t</div>\n");
      out.write("\t\t</div>\n");
      out.write("\t\t<a class=\"left carousel-control\" href=\"#myCarousel\" data-slide=\"prev\"><i\n");
      out.write("\t\t\tclass=\"glyphicon glyphicon-chevron-left\"></i></a> <a\n");
      out.write("\t\t\tclass=\"right carousel-control\" href=\"#myCarousel\" data-slide=\"next\"><i\n");
      ...
      out.write("\t\t\t");
      out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.evaluateExpression("${theaterAddress}", java.lang.String.class, (PageContext)_jspx_page_context, null));
      out.write(" /\n");
      out.write("\t\t\t<a id = \"directions\" href =\"https://www.google.com/maps/dir/");
      out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.evaluateExpression("${coordinate}", java.lang.String.class, (PageContext)_jspx_page_context, null));
      out.write('/');
      out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.evaluateExpression("${theaterAddressDirection}", java.lang.String.class, (PageContext)_jspx_page_context, null));
      out.write("\" style=\"font-size: 15px\">Get Directions</a>\n");
      out.write("\t\t\t</h2>\n");
      out.write("\t\t</div>\n");
      out.write("\t\t<br>\n");
      out.write("\t\t");
  ...
  private boolean _jspx_meth_c_url_2(PageContext _jspx_page_context)
    ...
    _jspx_th_c_url_2.setValue("/resources/css/blur.css");
  ...
  private boolean _jspx_meth_c_url_3(PageContext _jspx_page_context)
    ...
    _jspx_th_c_url_3.setValue("/resources/css/theater-detail.css");
  ...
  private boolean _jspx_meth_c_url_5(PageContext _jspx_page_context)
    ...
    _jspx_th_c_url_5.setValue("/resources/js/theater-detail.js");
  ...
  private boolean _jspx_meth_c_set_0(PageContext _jspx_page_context)
    ...
    _jspx_th_c_set_0.setVar("time");
    _jspx_th_c_set_0.setValue(new String("2017-05-17"));
  ...
  private boolean _jspx_meth_c_set_1(PageContext _jspx_page_context)
    ...
    _jspx_th_c_set_1.setVar("time");
    _jspx_th_c_set_1.setValue(new String("2017-05-18"));
  ...
  private boolean _jspx_meth_c_set_2(PageContext _jspx_page_context)
    ...
    _jspx_th_c_set_2.setVar("time");
    _jspx_th_c_set_2.setValue(new String("2017-05-19"));
  ...
  private boolean _jspx_meth_spring_url_0(PageContext _jspx_page_context)
    ...
    _jspx_th_spring_url_0.setValue((java.lang.String) org.apache.jasper.runtime.PageContextImpl.evaluateExpression("/theaters/${theater.id}", java.lang.String.class, (PageContext)_jspx_page_context, null));
  ...
  private boolean _jspx_meth_c_forEach_0(PageContext _jspx_page_context)
    ...
    _jspx_th_c_forEach_0.setItems((java.lang.Object) org.apache.jasper.runtime.PageContextImpl.evaluateExpression("${moviesInThisTheater}", java.lang.Object.class, (PageContext)_jspx_page_context, null));
    _jspx_th_c_forEach_0.setVar("movies");
    ...
    try {
      ...
      if (_jspx_eval_c_forEach_0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
        do {
          ...
          out.write("\t\t\t\t<div class=\"panel-body theaters\">\n");
          ...
          out.write("\"><img\n");
          out.write("\t\t\t\t\t\t\t\t\tsrc=\"");
          out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.evaluateExpression("${movies.url}", java.lang.String.class, (PageContext)_jspx_page_context, null));
          out.write("\" alt=\"Game 1\"\n");
          out.write("\t\t\t\t\t\t\t\t\tstyle=\"max-height: 250px; max-width: 130px\"></a>\n");
          out.write("\t\t\t\t\t\t\t</div>\n");
          out.write("\t\t\t\t\t\t</div>\n");
          ...
          out.write('"');
          out.write('>');
          out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.evaluateExpression("${movies.name}", java.lang.String.class, (PageContext)_jspx_page_context, null));
          out.write("</a>\n");
          out.write("\t\t\t\t\t\t\t</h1>\n");
          out.write("\t\t\t\t\t\t\t");
  ...
  private boolean _jspx_meth_spring_url_1(javax.servlet.jsp.tagext.JspTag _jspx_th_c_forEach_0, PageContext _jspx_page_context, int[] _jspx_push_body_count_c_forEach_0)
    ...
    _jspx_th_spring_url_1.setValue((java.lang.String) org.apache.jasper.runtime.PageContextImpl.evaluateExpression("/movies/${movies.id}", java.lang.String.class, (PageContext)_jspx_page_context, null));
  ...
  private boolean _jspx_meth_spring_url_2(javax.servlet.jsp.tagext.JspTag _jspx_th_c_forEach_0, PageContext _jspx_page_context, int[] _jspx_push_body_count_c_forEach_0)
    ...
    _jspx_th_spring_url_2.setValue((java.lang.String) org.apache.jasper.runtime.PageContextImpl.evaluateExpression("/movies/${movies.id}", java.lang.String.class, (PageContext)_jspx_page_context, null));
  ...
  private boolean _jspx_meth_c_forEach_1(javax.servlet.jsp.tagext.JspTag _jspx_th_c_forEach_0, PageContext _jspx_page_context, int[] _jspx_push_body_count_c_forEach_0)
    ...
    _jspx_th_c_forEach_1.setItems((java.lang.Object) org.apache.jasper.runtime.PageContextImpl.evaluateExpression("${movies.showings}", java.lang.Object.class, (PageContext)_jspx_page_context, null));
  ...
  private boolean _jspx_meth_c_if_1(javax.servlet.jsp.tagext.JspTag _jspx_th_c_forEach_1, PageContext _jspx_page_context, int[] _jspx_push_body_count_c_forEach_1)
    ...
    if (_jspx_eval_c_if_1 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
      do {
        out.write("\n");
        out.write("\t\t\t\t\t\t\t\t\t<button class=\"ui orange button\">\n");
        out.write("\t\t\t\t\t\t\t\t\t\t<a id = \"showing-button\" href=\"");
        if (_jspx_meth_spring_url_3((javax.servlet.jsp.tagext.JspTag) _jspx_th_c_if_1, _jspx_page_context, _jspx_push_body_count_c_forEach_1))
          return true;
        out.write('"');
        out.write('>');
        out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.evaluateExpression("${movie.startTime}", java.lang.String.class, (PageContext)_jspx_page_context, null));
        out.write("<a>\n");
        out.write("\t\t\t\t\t\t\t\t\t</button>\n");
        out.write("\t\t\t\t\t\t\t\t");
  ...
  private boolean _jspx_meth_spring_url_3(javax.servlet.jsp.tagext.JspTag _jspx_th_c_if_1, PageContext _jspx_page_context, int[] _jspx_push_body_count_c_forEach_1)
          throws Throwable {
    PageContext pageContext = _jspx_page_context;
    JspWriter out = _jspx_page_context.getOut();
    //  spring:url
    ...
    _jspx_th_spring_url_3.setParent((javax.servlet.jsp.tagext.Tag) _jspx_th_c_if_1);
    _jspx_th_spring_url_3.setValue((java.lang.String) org.apache.jasper.runtime.PageContextImpl.evaluateExpression("/theaters/${theater.id}/${movie.showingId}", java.lang.String.class, (PageContext)_jspx_page_context, null));
  ...
  private boolean _jspx_meth_c_if_2(javax.servlet.jsp.tagext.JspTag _jspx_th_c_forEach_1, PageContext _jspx_page_context, int[] _jspx_push_body_count_c_forEach_1)
    ...
    if (_jspx_eval_c_if_2 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
      do {
        ...
        out.write("\t\t\t\t\t\t\t\t\t<button class=\"ui orange button\">\n");
        out.write("\t\t\t\t\t\t\t\t\t\t<a id = \"showing-button\" href=\"");
        if (_jspx_meth_spring_url_4((javax.servlet.jsp.tagext.JspTag) _jspx_th_c_if_2, _jspx_page_context, _jspx_push_body_count_c_forEach_1))
          return true;
        out.write('"');
        out.write('>');
        out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.evaluateExpression("${movie.startTime}", java.lang.String.class, (PageContext)_jspx_page_context, null));
  ...
  private boolean _jspx_meth_spring_url_4(javax.servlet.jsp.tagext.JspTag _jspx_th_c_if_2, PageContext _jspx_page_context, int[] _jspx_push_body_count_c_forEach_1)
          throws Throwable {
    PageContext pageContext = _jspx_page_context;
    JspWriter out = _jspx_page_context.getOut();
    //  spring:url
    ...
    _jspx_th_spring_url_4.setParent((javax.servlet.jsp.tagext.Tag) _jspx_th_c_if_2);
    _jspx_th_spring_url_4.setValue("/login");
