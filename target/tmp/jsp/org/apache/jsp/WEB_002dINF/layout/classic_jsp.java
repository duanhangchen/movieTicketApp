...
public final class classic_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
    ...
    try {
      ...
      out.write("\t\t\t\t\t\t\t\t\t\t<li><a href=\"http://www.fandango.com/movie-news/news-briefs-charlize-theron-seth-rogen-to-star-in-flarsky-751962\"><img class=\"nav-movie-news-img\"\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\talt=\"\"\n");
      ...
      out.write("\t\t\t\t\t\t\t\t\t\t<li><a href=\"http://www.fandango.com/movie-news/logan-buzz-is-there-a-postcredits-scene-plus-what-might-bring-hugh-jackman-back-as-wolverine-751964\"><img class=\"nav-movie-news-img\"\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\talt=\"\"\n");
      ...
      out.write("\t\t\t\t\t\t\t\t\t<ul class=\"multi-column-dropdown\">\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<li class=\"coloumn-heading\"><a href=\"#\"><br></a></li>\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<li><a href=\"http://www.fandango.com/movie-news/more-batman-news-nightwing-is-getting-his-own-movie-751965\"><img class=\"nav-movie-news-img\"\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\talt=\"\"\n");
      ...
      out.write("\t\t\t\t\t\t\t</div>\n");
      out.write("\t\t\t\t\t\t</ul></li>\n");
      out.write("\t\t\t\t\t<li class=\"dropdown\"><a id=\"username\" href=\"#\" class=\"dropdown-toggle\"\n");
      out.write("\t\t\t\t\t\tdata-toggle=\"dropdown\" role=\"button\" aria-haspopup=\"true\"\n");
      out.write("\t\t\t\t\t\taria-expanded=\"false\">\n");
      out.write("\t\t\t\t\t\t ");
  ...
  private boolean _jspx_meth_c_if_4(javax.servlet.jsp.tagext.JspTag _jspx_th_c_if_3, PageContext _jspx_page_context)
    ...
    _jspx_th_c_if_4.setTest(((java.lang.Boolean) org.apache.jasper.runtime.PageContextImpl.evaluateExpression("${user.role=='user'}", java.lang.Boolean.class, (PageContext)_jspx_page_context, null)).booleanValue());
  ...
  private boolean _jspx_meth_c_if_5(javax.servlet.jsp.tagext.JspTag _jspx_th_c_if_3, PageContext _jspx_page_context)
    ...
    _jspx_th_c_if_5.setTest(((java.lang.Boolean) org.apache.jasper.runtime.PageContextImpl.evaluateExpression("${user.role=='client'}", java.lang.Boolean.class, (PageContext)_jspx_page_context, null)).booleanValue());
    int _jspx_eval_c_if_5 = _jspx_th_c_if_5.doStartTag();
    if (_jspx_eval_c_if_5 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
      do {
        out.write("\n");
        out.write("\t\t\t\t\t\t\t\t\t<a href=\"/user-dashboard\" class=\"text-primary\"><strong>CLIENT\n");
        out.write("\t\t\t\t\t\t\t\t\t\t\tACCOUNT</strong></a>\n");
        out.write("\t\t\t\t\t\t\t\t");
  ...
  private boolean _jspx_meth_c_if_6(javax.servlet.jsp.tagext.JspTag _jspx_th_c_if_3, PageContext _jspx_page_context)
    ...
    _jspx_th_c_if_6.setTest(((java.lang.Boolean) org.apache.jasper.runtime.PageContextImpl.evaluateExpression("${user.role=='user'}", java.lang.Boolean.class, (PageContext)_jspx_page_context, null)).booleanValue());
    int _jspx_eval_c_if_6 = _jspx_th_c_if_6.doStartTag();
    if (_jspx_eval_c_if_6 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
      do {
        out.write("\n");
        out.write("\t\t\t\t\t\t\t\t\t<a href=\"/giftcard\" class=\"text-primary\"> <strong>BUY GIFT CARD</strong></a>\n");
        out.write("\t\t\t\t\t\t\t\t");
