...
public class InitDbService {
	...
	public void init(){
		...
		Calendar BatmanDate = Calendar.getInstance();
		BatmanDate.set(1993,1,05);
		java.sql.Date testing=new java.sql.Date(BatmanDate.getTime().getTime());
		String plot="Batman plot blah blah blah";
		batman.setPlot(plot);
		batman.setReleaseDate(testing);
		...
		Calendar jackHughmanDoB = Calendar.getInstance();
