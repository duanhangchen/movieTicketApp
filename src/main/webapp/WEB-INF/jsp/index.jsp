		...
		<div class="carousel-inner" role="listbox">
			<div class="item active">
				<a href="https://play.google.com/store/apps?hl=en">
					<img src="http://i.imgur.com/SCt6khH.png" alt="Chania" width="600" height="259"></a>
			</div>
			
			<c:forEach items="${advertisement}" var="ads">
						<div class="item">
							<a href="${ads.adsUrl}">
								<img src="${ads.adsImageUrl}" alt="Chania" width="600" height="259"></a>
						</div>
					</c:forEach>
...
<br>
<br>
<h1 class="ui block header">FEATURED MOVIES</h1>
<br>
