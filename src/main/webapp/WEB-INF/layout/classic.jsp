...
<link href="<c:url value="/resources/css/sign-up.css" />"
	rel="stylesheet">
	...
	<div class="container-fluid">
		...
		<div class="collapse navbar-collapse"
			...
			<ul class="nav navbar-nav navbar-right">
					...
					<ul class="dropdown-menu multi-column columns-4 movie-news">
						<div class="row">
							<div class="col-sm-3">
								...
								<ul class="multi-column-dropdown">
									<li class="coloumn-heading"><a href="#">FEATURED MOVIE
											NEWS</a></li>
							...
							<div class="col-sm-3">
								<ul class="multi-column-dropdown">
									...
									<li><a href="#">'Logan' Buzz: Is There a Postcredits
											Scene? Plus: What Might Bring Hugh Jackman Back As Wolverine?</a></li>
								</ul>
							</div>
							<div class="col-sm-3">
								<ul class="multi-column-dropdown">
									...
									<li><a href="#">More Batman News: Nightwing Is Getting
											His Own Movie</a></li>
								</ul>
							</div>
							<div class="col-sm-3">
				...
				<li class="dropdown"><a href="#" class="dropdown-toggle"
					data-toggle="dropdown" role="button" aria-haspopup="true"
					aria-expanded="false"> <c:if test="${not empty name}">
                            ${name}
